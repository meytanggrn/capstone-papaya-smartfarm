<template>
  <div class="analisis-page-wrapper">
    ...
    <button @click="doPredict" :disabled="predictionLoading">
      {{ predictionLoading ? 'Memproses...' : 'Prediksi Lokal' }}
    </button>
    ...
    <div v-if="currentView !== 'realtime'" class="new-analisis-design-container">
      ...
      <div class="main-content-area">
        ...
        <div v-if="currentView === 'new-prediction'" class="prediction-section">
          ...
          <p v-if="prediction !== null">Prediksi Lokal: {{ prediction }} kg</p>
...
async function doPredict() {
  ...
  try {
    ...
    if (isNaN(input)) {
      predictionError.value = 'Masukkan suhu yang valid!'
      return
    }
    ...
    if (isNaN(hasil)) {
      predictionError.value = 'Hasil prediksi tidak valid (NaN). Coba lagi.'
      prediction.value = null
    } else {
